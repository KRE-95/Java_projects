package hiof.no.kainater.module;
    ...
    public class Star extends CelestialBody {
        // relevant for siste oppgave - // changes the effectiveTemp to a Double. from int to double [3]
        ...
        public Star(String name, double radius, double masse, double effectiveTemp) {
